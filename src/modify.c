...
const char *string_fields[] = { "name", "short", "long", "description", "title",
                                "delete-description", "\n" };
                  ...
                  void *data)
{
    ...
    if (data)
    {
        mudlog(BRF, LVL_IMMORT, TRUE,
               "SYSERR: string_write: I don't understand special data.");
    }
...
ACMD(do_skillset)
{
    ...
    strcpy(help,
           (argument + 1));    /* strcpy: OK (MAX_INPUT_LENGTH <= MAX_STRING_LENGTH) */
    help[qend - 1] = '\0';
